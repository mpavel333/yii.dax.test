...
use app\models\TemplateCarSearch;
...
/**
 * TemplateCarController implements the CRUD actions for TemplateCar model.
 */
class TemplateCarController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    {
        $searchModel = new TemplateCarSearch();
    ...
    /**
     * Finds the TemplateCar model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TemplateCar the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TemplateCar::findOne($id)) !== null) {
            return $model;
        } else {
