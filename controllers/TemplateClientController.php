...
use app\models\TemplateClientSearch;
...
/**
 * TemplateClientController implements the CRUD actions for TemplateClient model.
 */
class TemplateClientController extends Controller
{
    ...
    {
        $searchModel = new TemplateClientSearch();
    ...
    /**
     * Finds the TemplateClient model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TemplateClient the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TemplateClient::findOne($id)) !== null) {
            return $model;
        } else {
