...
use app\models\TemplateMetalSearch;
...
/**
 * TemplateMetalController implements the CRUD actions for Template model.
 */
class TemplateMetalController extends Controller
{
    ...
    {
        $searchModel = new TemplateMetalSearch();
    ...
    {
        if (($model = TemplateMetal::findOne($id)) !== null) {
            return $model;
        } else {
