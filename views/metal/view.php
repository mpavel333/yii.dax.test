            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="panel panel-default">
                      ...
                      <?= $form->field($model, 'shipping_date', ['cols' => 6, 'colsOptionsStr' => " "])->input('date', ['disabled' => true])  ?>
                                
                      <?php
                      // echo  $form->field($model, 'shipping_date_2', ['cols' => 3, 'colsOptionsStr' => " "])->input('date', ['style' => 'margin-top: 22px;', 'disabled' => true])->label(false)  
                      ?>

                                <?= $form->field($model, 'address_out4', ['cols' => 6, 'colsOptionsStr' => " "])->textInput(['disabled' => true])  ?>

                                <?= $form->field($model, 'date_out4', ['cols' => 6, 'colsOptionsStr' => " "])->input('date', ['disabled' => true])  ?>

                      <?php
                      // echo $form->field($model, 'date_out4_2', ['cols' => 3, 'colsOptionsStr' => " "])->input('date', ['style' => 'margin-top: 22px;', 'disabled' => true])->label(false)
                      ?>

                                <?= $form->field($model, 'address_out2', ['cols' => 6, 'colsOptionsStr' => " "])->textInput(['disabled' => true])  ?>

                                <?= $form->field($model, 'date_out2', ['cols' => 6, 'colsOptionsStr' => " "])->textInput(['disabled' => true])  ?>

                      <?php
                      // echo  $form->field($model, 'date_out2_2', ['cols' => 3, 'colsOptionsStr' => " "])->input('date', ['style' => 'margin-top: 22px;', 'disabled' => true])->label(false)
                      ?>

                                <?= $form->field($model, 'address_out5', ['cols' => 6, 'colsOptionsStr' => " "])->textInput(['disabled' => true])  ?>

                                <?= $form->field($model, 'date_out5', ['cols' => 6, 'colsOptionsStr' => " "])->input('date', ['disabled' => true])  ?>

                      <?php
                      // echo  $form->field($model, 'date_out5_2', ['cols' => 3, 'colsOptionsStr' => " "])->input('date', ['style' => 'margin-top: 22px;', 'disabled' => true])->label(false)
                      ?>

                                <?= $form->field($model, 'address_out3', ['cols' => 6, 'colsOptionsStr' => " "])->textInput(['disabled' => true])  ?>
                    
                                <?= $form->field($model, 'date_out3', ['cols' => 6, 'colsOptionsStr' => " "])->input('date', ['disabled' => true])  ?>

                      <?php
                        // echo $form->field($model, 'date_out3_2', ['cols' => 3, 'colsOptionsStr' => " "])->input('date', ['style' => 'margin-top: 22px;', 'disabled' => true])->label(false)
                        ?>

                                <?= $form->field($model, 'address', ['cols' => 6, 'colsOptionsStr' => " "])->textInput(['disabled' => true])  ?>

                                <?= $form->field($model, 'date_out6', ['cols' => 6, 'colsOptionsStr' => " "])->input('date', ['disabled' => true])  ?>

                      <?php 
                        // echo $form->field($model, 'date_out6_2', ['cols' => 3, 'colsOptionsStr' => " "])->input('date', ['style' => 'margin-top: 22px;', 'disabled' => true])->label(false)
                        ?>
                            </div>
                        </div>
                    </div>
                    ...
                    <table role="presentation" class="table table-striped">
                        ...
                        <?php  $counter = 0; foreach (json_decode($model->file, true) as $value):?>
                          <tr class="template-upload fade in">
                                ...
                                ?>
                                <a class="btn btn-success" href="<?= \yii\helpers\Url::toRoute(['flight/download-resource', 'path' => $value['url']]) ?>">
                                    <span>Скачать</span>
                                </a>
                    ...
                    <table role="presentation" class="table table-striped">
                        ...
                        <?php  $counter = 0; foreach (json_decode($model->file_provider, true) as $value):?>
                          <tr class="template-upload fade in">
                                ...
                                ?>
                                <a class="btn btn-success" <?= \yii\helpers\Url::toRoute(['flight/download-resource', 'path' => $value['url']]) ?>>
                                    <span>Скачать</span>
                                </a>
