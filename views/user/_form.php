...
<div class="user-form">
    ...
    <div class="row">
        ...
        <div id="div-role" class="col-md-3" style=" ">        
        ...
        <div id="div-date_of_birth" class="col-md-6" style=" ">        
             <?= $form->field($model, 'date_of_birth')->textInput()  ?>
        </div>
        <div id="div-phone" class="col-md-6" style=" ">        
             <?= $form->field($model, 'phone')->textInput()  ?>
        </div>
        <div id="div-dolzhnost" class="col-md-6" style=" ">        
             <?= $form->field($model, 'dolzhnost')->textInput()  ?>
        </div>
        ...
        <?php if(\Yii::$app->user->identity->isSuperAdmin() || \Yii::$app->user->identity->can('settings')): ?>
        <div id="div-email" class="col-md-12" style=" ">        
...
$script = <<< JS
    ...
    $( function() {
        $( "#user-date_of_birth" ).datepicker({ dateFormat: 'yy-mm-dd' });
    });
