...
$this->title = "Пользователи водители";
...
<div class="row">
  <div class="col-md-12" style="margin-bottom: 10px;">
          <?= Html::a(Yii::t('app', "Добавить") .'  <i class="fa fa-plus"></i>', ['user-driver/create'],
    ...
    <div class="col-md-12">
        <div class="card card-shadow m-b-10">
            <div class="row">
                <?php $form = \yii\widgets\ActiveForm::begin(['id' => 'search-form', 'method' => 'GET', 'action' => ['user-driver/index']]) ?>
                    ...
                    <div class="col-md-12">
                        <div style="float: right;">
                            <?= Html::a('Сбросить', ['user-driver/index'], ['class' => 'btn btn-white']) ?>
...
<?= \app\widgets\CardGrid::widget([
    ...
    'buttons' => [
        'update' => function($model){
            return Html::a('<i class="fa fa-pencil"></i>', ['user-driver/update', 'id' => $model->id], ['role' => 'modal-remote', 'title' => 'Редактировать', 'class' => 'btn btn-sm btn-white']);
        },
        'delete' => function($model){
            return Html::a('<i class="fa fa-trash"></i>', ['user-driver/delete', 'id' => $model->id], ['role'=>'modal-remote','title'=>'Удалить',
