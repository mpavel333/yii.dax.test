	...
	<div class="col-md-10">
		<div class="panel panel-inverse">
			<div class="panel-heading">
				<h4 class="panel-title">Yandex Карта</h4>
			</div>
	...
	<div class="col-md-2">
		<div class="panel panel-inverse">
			...
			<div class="panel-body">
				<div class="row">
					<div class="col-md-12">
                        <p style="font-size: 14px; margin-bottom: 5px; margin-top: 0;">Километраж</p>
                        <b style="font-size: 22px;"><?= number_format($model->distance, 0, '.', ' ') ?> Км.</b>
                    </div>
				</div>
			</div>
		</div>
