...
<div class="security-view">
    <div class="row">
        <div class="col-md-12">
        <?php Pjax::begin(['id' => 'crud-datatable-security-pjax', 'enablePushState' => true]); ?>        <div class="col-md-12">
...
<div class="btn-headeding-btn">
                    ...
                    <div class="panel-heading-btn" style="margin-top: -20px;">
                        <a class="btn btn-warning btn-xs" href="/security/update?id=<?= $model->id?>&amp;containerPjaxReload=%23pjax-container-info-container" role="modal-remote"><span class="glyphicon glyphicon-pencil"></span></a>
                    </div>
                </div>
