...
<?= \app\widgets\CardGrid::widget([
    ...
    'buttons' => [
        'update' => function($model){
            return Html::a('<i class="fa fa-pencil"></i>', ['template/update', 'id' => $model->id], ['title' => 'Редактировать', 'class' => 'btn btn-sm btn-white', 'data-pjax' => 0]);
        },
        'delete' => function($model){
            return Html::a('<i class="fa fa-trash"></i>', ['template/delete', 'id' => $model->id], ['role'=>'modal-remote','title'=>'Удалить',
