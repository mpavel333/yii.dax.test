...
return [
    ...
    'urlCreator' => function($action, $model, $key, $index) { 
            return Url::to(["mail-received"."/".$action,'id'=>$key]);
    },
   ...
   'buttons' => [
    ...
    [
         ...
         'label' => 'Название организации от кого письмо',
         'visible'=>\app\models\Mail::isVisibleAttr('organization_name'),
         'content' => function($model){
         	if($model->client){
	         	return \yii\helpers\ArrayHelper::getValue($model, 'client.name')." (".\yii\helpers\ArrayHelper::getValue($model, 'client.mailing_address').")";
         	}
         }
    ],
    [
    ...
    [
         'class'=>'\kartik\grid\DataColumn',
        'attribute'=>'when_receive',
        'label' => 'Когда получили',
