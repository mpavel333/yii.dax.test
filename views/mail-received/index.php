...
$this->title = "Почта | Входящие";
$this->params['breadcrumbs'][] = $this->title;

CrudAsset::register($this);

if(isset($additionalLinkParams)){
    $createUrl = ArrayHelper::merge(['mail-received/create'], $additionalLinkParams);
    $createUrl = ArrayHelper::merge($createUrl, ['display' => false]);
} else {
    $createUrl = ['mail-received/create'];
}
...
<div class="row">
  <div class="col-md-12" style="margin-bottom: 10px;">
          <?= Html::a(Yii::t('app', "Добавить") .'  <i class="fa fa-plus"></i>', ['mail-received/create'],
    ...
    <div class="col-md-12">
        <div class="card card-shadow m-b-10">
            <div class="row">
                <?php $form = \yii\widgets\ActiveForm::begin(['id' => 'search-form', 'method' => 'GET', 'action' => ['mail-received/index']]) ?>
                    ...
                    <div class="col-md-12">
                        <div style="float: right;">
                            <?= Html::a('Сбросить', ['mail-received/index'], ['class' => 'btn btn-white']) ?>
...
<?= \app\widgets\CardGrid::widget([
    ...
    'buttons' => [
        'update' => function($model){
            return Html::a('<i class="fa fa-pencil"></i>', ['mail-received/update', 'id' => $model->id], ['role' => 'modal-remote', 'title' => 'Редактировать', 'class' => 'btn btn-sm btn-white']);
        },
        'delete' => function($model){
            return Html::a('<i class="fa fa-trash"></i>', ['mail-received/delete', 'id' => $model->id], ['role'=>'modal-remote','title'=>'Удалить',
