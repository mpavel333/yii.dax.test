                    ...
                    <div class="panel-body" id="whitename-panel-body" style="overflow: auto; height: 80vh;">
                        ...
                        <?php ActiveForm::end() ?>
                            <?php foreach ($listTag as $tag => $label): ?>
                                    <a href='#' class="list-group-item list-group-item-action " onclick='event.preventDefault(); window.CKEDITOR.instances["templatecar-text"].insertHtml("<?=$tag?>");'><?=$label?></a> 
                            <?php endforeach; ?>
            ...
            <div class="panel panel-inverse">
                <div class="panel-body">
                    ...
                    <?php $form = ActiveForm::begin(); ?>
                        ...
                        <div class="col-md-6">
                            <?= $form->field($model, 'type')->dropDownList(TemplateCar::typeLabels()) ?>
                        </div>
