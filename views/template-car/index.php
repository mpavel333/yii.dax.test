...
<div class="row">
  <div class="col-md-12" style="margin-bottom: 10px;">
          <?= Html::a(Yii::t('app', "Добавить") .'  <i class="fa fa-plus"></i>', ['template-car/create'],
...
<?= \app\widgets\CardGrid::widget([
    ...
    'buttons' => [
        'update' => function($model){
            return Html::a('<i class="fa fa-pencil"></i>', ['template-car/update', 'id' => $model->id], ['title' => 'Редактировать', 'class' => 'btn btn-sm btn-white', 'data-pjax' => 0]);
        },
        'delete' => function($model){
            return Html::a('<i class="fa fa-trash"></i>', ['template-car/delete', 'id' => $model->id], ['role'=>'modal-remote','title'=>'Удалить',
