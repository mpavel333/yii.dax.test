...
$clientPaymentUrl = ArrayHelper::merge(\Yii::$app->request->queryParams, ['order/index', 'client_payment' => ($clientPayment ? 0 : 1)]);
$driverPaymentUrl = ArrayHelper::merge(\Yii::$app->request->queryParams, ['order/index', 'driver_payment' => ($driverPayment ? 0 : 1)]);
$clientPrepaymentUrl = ArrayHelper::merge(\Yii::$app->request->queryParams, ['order/index', 'client_prepayment' => ($clientPrepayment ? 0 : 1)]);
$driverPrepaymentUrl = ArrayHelper::merge(\Yii::$app->request->queryParams, ['order/index', 'driver_prepayment' => ($driverPrepayment ? 0 : 1)]);
...
<div class="col-md-12">
	<div class="card card-shadow m-b-10">
		<div class="row">
			<?php $form = ActiveForm::begin(['id' => 'search-form', 'method' => 'GET', 'action' => ['flight/index']]) ?>
			...
			<?= $form->field($searchModel, 'organization_id', ['cols' => 2, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
					// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Requisite::find()->all(), 'id', 'name'),
					'data' => [],
			...
			<?= $form->field($searchModel, 'carrier_id', ['cols' => 2, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
					// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Client::find()->all(), 'id', 'tel'),
                    'options' => ['prompt' => '', 'multiple' => false],
                       'pluginOptions' => [
                              'allowClear' => true,
                              'tags' => false,
			...
			<?= $form->field($searchModel, 'driver_phone', ['cols' => 2, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
					...
					// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Driver::find()->all(), 'phone', 'phone'),
                    'options' => ['prompt' => '', 'multiple' => false],
                    'pluginOptions' => [
                              'allowClear' => true,
                              'tags' => false,
                              'tokenSeparators' => [','],
                              'ajax' => [
                              	'url' => '/driver/data?attr=phone&key=phone',
		                        'dataType' => 'json',
		                        'data' => new \yii\web\JsExpression('function(params) { return {q:params.term}; }')
                              ],
                       ]
			...
			<?= $form->field($searchModel, 'driver_car_number', ['cols' => 2, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
								// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Driver::find()->all(), 'car_number', 'car_number'),
								'options' => ['prompt' => '', 'multiple' => false],
								'pluginOptions' => [
										'allowClear' => true,
										'tags' => false,
			...
			<?= $form->field($searchModel, 'we', ['cols' => 2, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
								// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Flight::find()->all(), 'we', 'we'),
								'options' => ['prompt' => '', 'multiple' => false],
								'pluginOptions' => [
										'allowClear' => true,
										'tags' => false,
			...
			<?= $form->field($searchModel, 'pay_us', ['cols' => 2, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
								// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Flight::find()->all(), 'pay_us', 'pay_us'),
								'options' => ['prompt' => '', 'multiple' => false],
								'pluginOptions' => [
										'allowClear' => true,
										'tags' => false,
			...
			<?= $form->field($searchModel, 'otherwise2', ['cols' => 2, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
								// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Flight::find()->all(), 'otherwise2', 'otherwise2'),
								'options' => ['prompt' => '', 'multiple' => false],
								'pluginOptions' => [
										'allowClear' => true,
										'tags' => false,
		...
		<?= $form->field($searchModel, 'salary', ['cols' => 1, 'colsOptionsStr' => " ", 'checkPermission' => false,])->widget(\kartik\select2\Select2::class, [
								// 'data' => \yii\helpers\ArrayHelper::map(\app\models\Flight::find()->all(), 'salary', 'salary'),
								'options' => ['prompt' => '', 'multiple' => false],
								'pluginOptions' => [
										'allowClear' => true,
										'tags' => false,
