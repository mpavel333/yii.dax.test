...
class ManufacturerController extends Controller
{
    ...
    public function behaviors()
    {
        return [
            ...
            'role' => [
                ...
                'instanceQuery' => \app\models\Manufacturer::find(),
                'actions' => [
                    'create' => 'books',
                    'update' => 'books',
                    'view' => 'books',
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new \app\models\ManufacturerSearch();
    ...
    */
    ...
    public function actionView($id)
    {
        ...
        $result["mini_menu"] = [
            'items' => [
                ['label' => Yii::t('app', 'Товары'),  'url' => ['/goods?category_id='.$model->id]],
                ['label' => Yii::t('app', 'Модель производителя'),  'url' => ['/model-provider?producer_id='.$model->id]],
