...
*
    * @property int $flight_id Заявка
    * @property  $text Текст
    * @property int $user_id Пользователь
    * @property int $user_to_id Кому
    * @property  $create_at Дата и время
    * @property  $is_read Прочитано
*/
class Message extends \app\base\ActiveRecord
{
    ...
    */
    public function rules()
    {
        return [
            ...
            [['flight_id', 'user_id', 'user_to_id', 'is_read'], 'integer'],
            [['text', 'create_at'], 'safe'],
        ];
    }
    ...
    */
    ...
    {
        return [
            'flight_id' => Yii::t('app', 'Заявка'),
            'text' => Yii::t('app', 'Текст'),
            'user_id' => Yii::t('app', 'Пользователь'),
            'user_to_id' => Yii::t('app', 'Кому'),
    ...
    {
        return [
			'flight_id' => [Flight::class, 'index'],
			'user_id' => [User::class, 'name'],
			'user_to_id' => [User::class, 'login'],
        ];
    }
    ...
    */
    ...
    public function tableGenerate($text, $json)
    {
        ...
        $nameStructure = str_replace('message.', '', $nameStructure);
