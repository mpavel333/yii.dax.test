...
*
    ...
    * @property  $is_read Прочитан
*/
class TicketMessage extends \app\base\ActiveRecord
{
    ...
    */
    ...
    {
        return 'Сообщения технической поддержки';
    }
    ...
    */
    public function rules()
    {
        return [
            ...
            [['ticket_id', 'user_id', 'is_read'], 'integer'],
            [['text'], 'string'],
            [['application', 'create_at'], 'safe'],
        ];
    }
    ...
    */
    public function attributeLabels()
    {
        return [
            ...
            'application' => Yii::t('app', 'Приложение'),
            'user_id' => Yii::t('app', 'Пользователь'),
            'create_at' => Yii::t('app', 'Дата и время'),
            'is_read' => Yii::t('app', 'Прочитан'),
    ...
    {
        return [
			'ticket_id' => [Ticket::class, 'subject'],
    ...
    */
    ...
    public function tableGenerate($text, $json)
    {
        ...
        $nameStructure = str_replace('ticket_message.', '', $nameStructure);
